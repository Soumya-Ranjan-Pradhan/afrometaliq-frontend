  ...
  return (
    <footer className="bg-gradient-to-r from-[rgb(20,161,168)] to-[rgb(3,105,161)] text-white py-10 mt-auto relative">
      <div className=" mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:px-7 border border-gray-300 lg:py-5 md:px-6 md:py-4 px-5 py-4 flex flex-col h-full">
          ...
          <ul className="space-y-2 flex-grow">
            <li><Link href="/about" className="hover:underline">{t("menu.about")}</Link></li>
            <li><Link href="/gallery" className="hover:underline">{t("menu.gallery")}</Link></li>
            <li><Link href="/contact" className="hover:underline">{t("menu.contact_us")}</Link></li>
          </ul>
        </div>
        ...
        <div className="lg:px-7 border border-gray-300 lg:py-5 md:px-6 md:py-4 px-5 py-4 flex flex-col h-full">
          ...
          <ul className="space-y-2 flex-grow">
            <li><Link href="/fabrication" className="hover:underline">{t("industrial")}</Link></li>
            <li><Link href="/fabrication" className="hover:underline">{t("commercial_building")}</Link></li>
            <li><Link href="/fabrication" className="hover:underline">{t("residential_building")}</Link></li>
            <li><Link href="/fabrication" className="hover:underline">{t("pre-Fab_structure")}</Link></li>
            <li><Link href="/fabrication" className="hover:underline">{t("turnkey_project")}</Link></li>
          </ul>
        </div>
        ...
        <div className="lg:px-7 border border-gray-300 lg:py-5 md:px-6 md:py-4 px-5 py-4 flex flex-col h-full">
          ...
          <ul className="space-y-2 flex-grow">
            <li><Link href="/consultancy" className="hover:underline">{t("it_solution")}</Link></li>
            <li><Link href="/consultancy" className="hover:underline">{t("expatriate_management")}</Link></li>
            <li><Link href="/consultancy" className="hover:underline">{t("accountancy")}</Link></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-400 text-center text-sm text-gray-300 py-4 mt-6 pb-6 lg:pb-4">
        &copy; {new Date().getFullYear()} Afro MetaliQ. {t("all_rights_reserved")}
      </div>
