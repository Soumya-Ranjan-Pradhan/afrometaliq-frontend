            ...
            <tbody>
              {products.map((product, index) => (
                ...
                >
                  ...
                  <td className="p-4 whitespace-nowrap">{product.productUnit}</td>
                  <td className="p-4 whitespace-nowrap" >{product.productCategory}</td>
                  <td className="p-4 whitespace-nowrap">{product.productSubCategory}</td>
                  ...
                  <td className="p-4 whitespace-nowrap">{product.productSize}</td>
                  <td className="p-4 whitespace-nowrap">{product.productGrade}</td>
                  <td className="p-4 whitespace-nowrap">{product.productThickness}</td>
                  <td className="p-4 whitespace-nowrap">{product.productUOm}</td>
                  <td className="p-4 whitespace-nowrap">{product.productLength}</td>
                  <td className="p-4 whitespace-nowrap">{product.productWidth}</td>
                  <td
